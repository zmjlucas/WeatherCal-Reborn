...
import type { EditingCategory, GetCalendars, WidgetSettings } from '../../types/settings';

export default async function(this: WeatherCalContext, getFromCalendar: GetCalendars): Promise<{ widget: EditingCategory<WidgetSettings> }> {
  return {
      widget: {
