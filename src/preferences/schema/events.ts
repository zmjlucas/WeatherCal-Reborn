...
import type { EditingCategory, GetCalendars, EventsSettings } from '../../types/settings';

export default async function(this: WeatherCalContext, getFromCalendar: GetCalendars): Promise<{ events: EditingCategory<EventsSettings> }> {
  return {
      events: {
        name: "Events",
        numberOfEvents: {
