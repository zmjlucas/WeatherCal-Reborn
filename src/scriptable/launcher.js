...
const gitHubUrl = "https://github.com/zmjlucas/WeatherCal-Reborn/releases/latest/download/weather-cal-code.js"
...
if (!files.fileExists(pathToCode)) {
  ...
  if (!codeString.startsWith("// Variables used by Scriptable.")) {
    throw new Error("The downloaded Weather Cal module is invalid. Install both built scripts manually.")
  }
